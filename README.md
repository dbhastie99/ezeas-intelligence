...
Worker Story baseline capture policy and checked-in baseline packs are documented under [docs/evaluation/worker_story_baselines/](docs/evaluation/worker_story_baselines/), with the DB readiness check documented in [WORKER_STORY_BASELINE_DB_READINESS.md](docs/evaluation/worker_story_baselines/WORKER_STORY_BASELINE_DB_READINESS.md). The v0.3 captured baseline records READY database readiness, benchmark result 5 total / 4 passed / 1 failed, corpus coverage 10 STRONG / 0 WEAK / 0 MISSING and answer gap status GOOD with all groups KEEP. The historical four-domain batch close-out is recorded in [BASELINE_BATCH_CLOSEOUT_2026_05_13.md](docs/evaluation/worker_story_baselines/BASELINE_BATCH_CLOSEOUT_2026_05_13.md), the first six-domain maturity close-out is recorded in [BASELINE_MATURITY_CLOSEOUT_2026_05_13.md](docs/evaluation/worker_story_baselines/BASELINE_MATURITY_CLOSEOUT_2026_05_13.md), the blocked Core Payroll Explanation batch is recorded in [CORE_PAYROLL_EXPLANATION_BASELINE_BATCH_2026_05_13.md](docs/evaluation/worker_story_baselines/CORE_PAYROLL_EXPLANATION_BASELINE_BATCH_2026_05_13.md), the completed Core Payroll Explanation batch close-out is recorded in [CORE_PAYROLL_EXPLANATION_BATCH_CLOSEOUT_2026_05_13.md](docs/evaluation/worker_story_baselines/CORE_PAYROLL_EXPLANATION_BATCH_CLOSEOUT_2026_05_13.md), and the blocked Payroll Evidence Context batch is recorded in [PAYROLL_EVIDENCE_CONTEXT_BASELINE_BATCH_2026_05_13.md](docs/evaluation/worker_story_baselines/PAYROLL_EVIDENCE_CONTEXT_BASELINE_BATCH_2026_05_13.md). These artefacts are comparison controls only; they do not mutate corpus, change routing, change answer generation, call a live LLM, ingest operational JSON, connect Code Evidence, or prove runtime platform truth.

Formal evidence control starts at [docs/evaluation/source_evidence_drafts/FORMAL_EVIDENCE_CONTROL_INDEX.md](docs/evaluation/source_evidence_drafts/FORMAL_EVIDENCE_CONTROL_INDEX.md). It is the master starting point/control index for formal evidence review gates, decision records, readiness checklists, status transitions, governed ingestion planning, recapture planning, promotion planning, and promotion execution guardrails. Tax / PAYG and Imports / Actuals remain `BASELINE_REQUIRED` and `NOT_REVIEWED`; governed ingestion permitted: No; recapture permitted: No; promotion permitted: No.
...
Run the diagnostic-only Annual Leave / Leave Management corpus coverage scan:
...
Build the diagnostic-only Annual Leave / Leave Management answer gap report from the coverage JSON:
