...
class AIInteractionAudit(Base):
    ...
    UserQuestion: Mapped[str] = mapped_column(Text, nullable=False)
    RetrievedChunkIdsJson: Mapped[str] = mapped_column(Text, nullable=False)
    RetrievedDocumentIdsJson: Mapped[str] = mapped_column(Text, nullable=False)
    SourceReferencesJson: Mapped[str] = mapped_column(Text, nullable=False)
    ModelName: Mapped[str] = mapped_column(String(100), nullable=False, default="STUB_LLM")
    PromptPolicy: Mapped[str] = mapped_column(String(100), nullable=False, default="MINERVA_V0_GROUNDED_READ_ONLY")
    ResponseText: Mapped[str] = mapped_column(Text, nullable=False)
