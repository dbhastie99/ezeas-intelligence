...
PROCESS_PERIOD_PAYRUN_LIFECYCLE_GROUP_SIGNAL_TERMS = {
    "purpose_and_operator_meaning": ("Process Periods / PayRun Lifecycle", "ProcessPeriod", "Process Period", "PayRun", "not payroll calculation truth"),
    ...
    "close_rolls_forward": ("close rolls forward", "roll forward", "rolls forward", "open next period", "next period"),
    ...
    "outstanding_hardening": ("outstanding hardening", "hardening", "operation trackers", "lifecycle contracts", "not implemented"),
}
