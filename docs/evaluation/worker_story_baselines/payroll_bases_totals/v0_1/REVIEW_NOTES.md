...
These notes define the manual review checklist for the Payroll Bases & Totals baseline capture attempt. They are diagnostic-only and not operational truth.
...
- Is the decision ledger clear that Payroll Bases & Totals is not yet treated as `BASELINE_ALREADY_EXISTS`?
