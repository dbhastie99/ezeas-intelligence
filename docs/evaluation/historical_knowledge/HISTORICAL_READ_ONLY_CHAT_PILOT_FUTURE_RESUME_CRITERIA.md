# Historical Read-Only Chat Pilot Future Resume Criteria
...
This document defines criteria required before any future Minerva historical read-only chat pilot exposure slice may resume after stream closeout.
...
Meeting these criteria authorises only consideration of a future internal exposure candidate. It does not expose chat, create production access, register global routes, call live LLMs, generate final natural-language answers, connect live retrieval, query or mutate corpus, read or write databases, ingest sources, ingest Code Evidence, migrate schemas, or change workforce-platform, award-configurator-v1, or ezeas-analytics.
