...
HISTORICAL_READ_ONLY_CHAT_PILOT_ORCHESTRATOR_RESPONSE_CONTRACT = (
    HISTORICAL_KNOWLEDGE_ROOT
...
HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_DESIGN_PACK = (
    HISTORICAL_KNOWLEDGE_ROOT
...
HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_DECISION_RECORD = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_DECISION_RECORD.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_RESUME_CRITERIA = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_RESUME_CRITERIA.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_BLOCKER_MODEL = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_BLOCKER_MODEL.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_NO_RUN_ATTESTATION = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_NO_RUN_ATTESTATION.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_DECISION_RECORD = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_DECISION_RECORD.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_ARTEFACT_INVENTORY = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_ARTEFACT_INVENTORY.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_FUTURE_RESUME_CRITERIA = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_FUTURE_RESUME_CRITERIA.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_NO_EXPOSURE_ATTESTATION = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_NO_EXPOSURE_ATTESTATION.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX = (
    HISTORICAL_KNOWLEDGE_ROOT / "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_STATUS = (
    HISTORICAL_KNOWLEDGE_ROOT / "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_STATUS.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_RESUME_MAP = (
    HISTORICAL_KNOWLEDGE_ROOT / "HISTORICAL_READ_ONLY_CHAT_PILOT_RESUME_MAP.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_BOUNDARY_REGISTER = (
    HISTORICAL_KNOWLEDGE_ROOT
    / "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_BOUNDARY_REGISTER.md"
)
...
HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT_PROMPT = Path(
    "docs/codex_prompts/2026-05-16_minerva_historical_read_only_chat_pilot_internal_exposure_deferred_closeout_v0_1.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT_PROMPT = Path(
    "docs/codex_prompts/2026-05-16_minerva_historical_read_only_chat_pilot_readiness_stream_closeout_v0_1.md"
)
HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX_RESUME_MAP_PROMPT = Path(
    "docs/codex_prompts/2026-05-16_minerva_historical_read_only_chat_pilot_final_index_resume_map_v0_1.md"
)
...
def _approved_orchestrator_metadata() -> dict[str, object]:
    return {
        "SourceId": "HIST-ORCH-CT-001",
        "EvidenceScope": "CURRENT_TRUTH",
        "AnswerUsePermissionStatus": "APPROVED",
        "RetrievalEligibilityStatus": "APPROVED",
        "AnswerMode": "CURRENT_TRUTH",
        ...
        "CitationRequired": True,
        "CaveatRequired": False,
        "SourceTitle": "Historical Orchestrator Fixture",
        "SourceDate": "2026-05-16",
        "UnknownDateMarker": "",
        "RepositoryContext": "ezeas-intelligence",
        "DomainContext": "Minerva historical knowledge",
        "AnswerUsePermissionId": "AUP-HIST-ORCH-001",
        "RetrievalEligibilityId": "RET-HIST-ORCH-001",
        "AnswerModeId": "ANS-HIST-ORCH-001",
    }


def _run_orchestrator(metadata: dict[str, object]) -> dict[str, object]:
    ...
    return evaluate_historical_read_only_chat_pilot_orchestrator_candidate(metadata)


def test_historical_read_only_chat_pilot_orchestrator_docs_and_service_exist():
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_IMPLEMENTATION_CANDIDATE.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_ORCHESTRATOR_RESPONSE_CONTRACT.exists()
...
def test_historical_read_only_chat_pilot_orchestrator_response_defaults_are_no_runtime():
    response = _run_orchestrator(_approved_orchestrator_metadata())
    ...
    assert response["ChatPilotOrchestratorCandidateImplemented"] is True
    assert response["LiveLLMCalled"] is False
    assert response["FinalAnswerGenerated"] is False
    assert response["ChatExposed"] is False
    assert response["EndpointUIPresent"] is False
...
def test_historical_read_only_chat_pilot_orchestrator_ready_envelopes():
    current_truth = _run_orchestrator(_approved_orchestrator_metadata())
    assert current_truth["PilotResponseStatus"] == "READY_CURRENT_TRUTH_ENVELOPE"
    assert current_truth["FinalAnswerGenerated"] is False

    historical_context = _approved_orchestrator_metadata()
    historical_context["EvidenceScope"] = "HISTORICAL_CONTEXT_ONLY"
    historical_context["AnswerMode"] = "HISTORICAL_CONTEXT"
    historical_context["CurrentTruthPermitted"] = False
    historical_context_response = _run_orchestrator(historical_context)
    assert historical_context_response["PilotResponseStatus"] == (
        "READY_HISTORICAL_CONTEXT_ENVELOPE"
    )
    assert historical_context_response["PilotResponseStatus"] != "READY_CURRENT_TRUTH_ENVELOPE"

    caveated = _approved_orchestrator_metadata()
    caveated["CaveatRequired"] = True
    caveated_response = _run_orchestrator(caveated)
    assert caveated_response["PilotResponseStatus"] == "READY_CAVEATED_ENVELOPE"
    assert caveated_response["CaveatRequired"] is True


def test_historical_read_only_chat_pilot_orchestrator_refusal_preservation():
    cases = (
        ("AnswerUsePermissionStatus", "MISSING"),
        ("RetrievalEligibilityStatus", "MISSING"),
    ...
    for field_name, value in cases:
        ...
        metadata[field_name] = value
        response = _run_orchestrator(metadata)
        assert response["PilotResponseStatus"] == "REFUSAL_ENVELOPE"
        assert response["RefusalRequired"] is True
        assert response["CitationReady"] is False

    conflicted = _approved_orchestrator_metadata()
    conflicted["ConflictStatus"] = "CONFLICTED"
    conflicted_response = _run_orchestrator(conflicted)
    assert conflicted_response["PilotResponseStatus"] == "REFUSAL_ENVELOPE"

    caveat_ready_conflict = _approved_orchestrator_metadata()
    caveat_ready_conflict["ConflictStatus"] = "CONFLICTED"
    caveat_ready_conflict["CaveatRequired"] = True
    caveat_ready_conflict["CaveatReady"] = True
    caveat_ready_conflict["CaveatApproved"] = True
    caveat_ready_response = _run_orchestrator(caveat_ready_conflict)
    assert caveat_ready_response["PilotResponseStatus"] == "READY_CAVEATED_ENVELOPE"
    assert caveat_ready_response["CaveatRequired"] is True

    prior_refusal = _approved_orchestrator_metadata()
    prior_refusal["EvidenceAnswerable"] = False
    prior_refusal_response = _run_orchestrator(prior_refusal)
    assert prior_refusal_response["PilotResponseStatus"] == "REFUSAL_ENVELOPE"
    assert prior_refusal_response["CitationRefusalGateResult"]["CitationRefusalDecision"] == (
        "REFUSE_PRIOR_GATE_REFUSAL"
    )
...
def test_historical_read_only_chat_pilot_endpoint_ui_design_pack_docs_exist():
    for path in (
        HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_DESIGN_PACK,
        HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_CONTRACT_DESIGN,
        HISTORICAL_READ_ONLY_CHAT_PILOT_UI_SURFACE_DESIGN,
...
def test_historical_read_only_chat_pilot_endpoint_ui_design_pack_status_inputs_and_model():
    ...
    for status_line in (
        ...
        assert status_line in design_pack
    ...
    for reviewed_doc in (
        ...
        assert reviewed_doc in design_pack
    ...
    for status in (
        ...
        assert status in design_pack


def test_historical_read_only_chat_pilot_endpoint_ui_design_pack_summaries_and_envelopes():
    design_pack = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_DESIGN_PACK)

    for endpoint_requirement in (
        ...
        assert endpoint_requirement in design_pack

    for ui_requirement in (
        ...
        assert ui_requirement in design_pack
...
def test_historical_read_only_chat_pilot_endpoint_ui_design_pack_visibility_access_audit_and_boundaries():
    design_pack = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_DESIGN_PACK)

    for visibility_requirement in (
        ...
        assert visibility_requirement in design_pack
    ...
    for access_requirement in (
        ...
        assert access_requirement in design_pack
    ...
    for audit_field in (
        ...
        assert audit_field in design_pack
    ...
    for permission in (
        ...
        assert permission in design_pack


def test_historical_read_only_chat_pilot_endpoint_ui_design_pack_stops_and_authorisation_limits():
    design_pack = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_DESIGN_PACK)
    ...
    for stop_condition in (
        ...
        assert stop_condition in design_pack

    assert "a future endpoint/UI implementation gate may be considered" in design_pack
    assert "any future endpoint/UI creation must be separately approved" in design_pack
    ...
    for prohibited in (
        ...
        assert prohibited in design_pack

    assert (
        "Preferred next Minerva slice should be historical read-only chat pilot "
        "endpoint/UI implementation gate v0.1"
    ) in design_pack
    assert "Minerva has moved from endpoint/UI planning gate into endpoint/UI design" in design_pack
    assert "Minerva remains pre-chat-exposure" in design_pack
    assert "Endpoint/UI/live LLM/final answer generation remain separate future decisions" in design_pack


def test_historical_read_only_chat_pilot_endpoint_ui_design_companion_docs_and_entry_criteria():
    endpoint_contract = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_CONTRACT_DESIGN)
    ui_surface = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_UI_SURFACE_DESIGN)
    access_control = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ACCESS_CONTROL_DESIGN)
    audit_logging = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_AUDIT_LOGGING_DESIGN)
    implementation_entry = _read(
        HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_IMPLEMENTATION_ENTRY_CRITERIA
    )

    assert "No endpoint, route, controller, or API handler is created" in endpoint_contract
    assert "No UI is created" in ui_surface
    assert "Access control is design only" in access_control
    assert "No audit logging runtime is implemented" in audit_logging
    ...
    for ui_requirement in (
        ...
        assert ui_requirement in ui_surface
    ...
    for access_requirement in (
        ...
        assert access_requirement in access_control
    ...
    for audit_field in (
        ...
        assert audit_field in audit_logging
    ...
    for criterion in (
        ...
        assert criterion in implementation_entry


def test_historical_read_only_chat_pilot_endpoint_ui_design_updates_existing_controls():
    gate = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_PLANNING_GATE)
    blockers = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_BLOCKER_MODEL)
    rules = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_BOUNDARY_RULES)
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ORCHESTRATOR_CLOSEOUT)
    response_contract = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ORCHESTRATOR_RESPONSE_CONTRACT)
    runtime_boundaries = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_REMAINING_RUNTIME_BOUNDARIES)
    index = _read(HISTORICAL_KNOWLEDGE_CONTROL_INDEX)

    assert "flows into endpoint/UI design, not endpoint/UI creation" in gate
    ...
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_DESIGN_PACK.md" in rules
    assert "endpoint/UI design pack is not endpoint/UI creation" in rules
    assert "endpoint/UI design pack is not chat exposure" in rules

    for orchestrator_doc in (closeout, response_contract):
        assert "Endpoint/UI design consumes the orchestrator envelope only" in orchestrator_doc
        assert "does not create endpoint/UI" in orchestrator_doc

    assert "endpoint/UI design pack completed as a planned boundary" in runtime_boundaries
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_DESIGN_PACK.md" in runtime_boundaries
    ...
    for linked_doc in (
        ...
        "HISTORICAL_READ_ONLY_CHAT_PILOT_AUDIT_LOGGING_DESIGN.md",
        "HISTORICAL_READ_ONLY_CHAT_PILOT_ENDPOINT_UI_IMPLEMENTATION_ENTRY_CRITERIA.md",
        "2026-05-16_minerva_historical_read_only_chat_pilot_endpoint_ui_design_pack_v0_1.md",
        "DESIGN_DRAFTED_NOT_IMPLEMENTED",
    ):
        assert linked_doc in index
...
def test_historical_read_only_chat_pilot_exposure_decision_gate_updates_existing_controls():
    ...
    assert "flows into `HISTORICAL_READ_ONLY_CHAT_PILOT_EXPOSURE_DECISION_GATE.md`" in closeout
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT.md" in closeout
...
def test_historical_read_only_chat_pilot_internal_exposure_deferred_docs_exist():
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_DECISION_RECORD.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_RESUME_CRITERIA.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_BLOCKER_MODEL.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_NO_RUN_ATTESTATION.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT_PROMPT.exists()


def test_historical_read_only_chat_pilot_internal_exposure_deferred_closeout_status_and_model():
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT)
...
def test_historical_read_only_chat_pilot_internal_exposure_deferred_closeout_decision_candidate_and_resume():
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT)
    ...
    for required_input in (
        ...
        assert required_input in closeout
    ...
    for evidence_field in (
        ...
        assert evidence_field in closeout


def test_historical_read_only_chat_pilot_internal_exposure_deferred_closeout_boundaries_stops_and_authorisation():
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT)
    ...
    for stop_condition in (
        ...
        assert stop_condition in closeout

    assert "future internal exposure may be reconsidered if explicit approval and resume criteria are supplied" in closeout
    assert "current Minerva read-only chat pilot readiness stream may be considered closed/deferred" in closeout
...
def test_historical_read_only_chat_pilot_internal_exposure_deferred_decision_record_defaults_are_conservative():
    record = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_DECISION_RECORD)
    ...
    for field in (
        ...
        "DecisionDate",
        "CandidateService",
        "ExplicitExposureApprovalPresent",
        "InternalExposureEnabledThisSlice",
        "ProductionChatExposedThisSlice",
        "PublicAccessEnabledThisSlice",
        "TenantCustomerAccessEnabledThisSlice",
        "GlobalRouteRegisteredThisSlice",
        "LiveLLMCalledThisSlice",
        "FinalAnswerGeneratedThisSlice",
        "DBReadPerformedThisSlice",
        "DBWritePerformedThisSlice",
        "DeferralReason",
        "ResumeCriteria",
        "Blockers",
        "DecisionRationale",
...
def test_historical_read_only_chat_pilot_internal_exposure_resume_criteria_and_blocker_model():
    criteria = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_RESUME_CRITERIA)
    blocker_model = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_BLOCKER_MODEL)
...
def test_historical_read_only_chat_pilot_internal_exposure_no_run_attestation():
    attestation = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_NO_RUN_ATTESTATION)
...
def test_historical_read_only_chat_pilot_internal_exposure_deferred_closeout_updates_existing_controls():
    gate = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_EXPOSURE_DECISION_GATE)
    criteria = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_ENTRY_CRITERIA)
    boundaries = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_REMAINING_RUNTIME_BOUNDARIES)
    index = _read(HISTORICAL_KNOWLEDGE_CONTROL_INDEX)

    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT.md" in gate
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_RESUME_CRITERIA.md" in criteria
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_DECISION_RECORD.md" in criteria
    assert "internal exposure deferred closeout as the current boundary" in boundaries
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT.md" in boundaries
    ...
    for linked_doc in (
        ...
        "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_BLOCKER_MODEL.md",
        "HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_NO_RUN_ATTESTATION.md",
        "2026-05-16_minerva_historical_read_only_chat_pilot_internal_exposure_deferred_closeout_v0_1.md",
        "DEFERRED_NO_EXPLICIT_EXPOSURE_APPROVAL",
    ):
        assert linked_doc in index


def test_historical_read_only_chat_pilot_internal_exposure_deferred_slice_introduces_only_allowed_changes():
    changed = subprocess.run(
        ["git", "status", "--short"],
        capture_output=True,
        text=True,
...
def test_historical_read_only_chat_pilot_readiness_stream_closeout_docs_exist():
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_DECISION_RECORD.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_ARTEFACT_INVENTORY.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_FUTURE_RESUME_CRITERIA.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_NO_EXPOSURE_ATTESTATION.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT_PROMPT.exists()


def test_historical_read_only_chat_pilot_readiness_stream_closeout_status_and_model():
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT)
...
def test_historical_read_only_chat_pilot_readiness_stream_closeout_inputs_and_inventory():
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT)
    inventory = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_ARTEFACT_INVENTORY)
    combined = closeout + "\n" + inventory
    ...
    for stream_area in (
        ...
        "citation/refusal skeleton",
        "safety test pack",
        "go/no-go closeout",
        "orchestrator candidate",
        "orchestrator closeout",
        "endpoint/UI planning gate",
        "endpoint/UI design pack",
        "endpoint/UI implementation gate",
        "minimal endpoint/UI implementation candidate",
        "minimal endpoint/UI candidate closeout",
        "exposure decision gate",
        "internal exposure deferred closeout",
    ):
        assert stream_area in combined

    assert "Complete Stream Inventory" in inventory
    assert "no-runtime" in inventory
    assert "not globally registered" in inventory


def test_historical_read_only_chat_pilot_readiness_stream_positions_and_deferral():
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT)

    for required_text in (
        "Governance/skeleton readiness is complete for current purposes",
        "Answer-use, retrieval, answer-mode, and citation gates remain required",
        "Historical sources do not become current truth by default",
        "Skeleton and orchestrator services remain in-memory metadata-only",
        "no live retrieval backend",
        "no live LLM",
        "no final answer generation",
        "no DB read/write",
        "no corpus mutation",
        "The minimal endpoint/UI candidate service exists",
        "candidate remains internal metadata/envelope-only",
        "remains not globally registered",
        "remains not production chat",
        "subject to future explicit exposure approval",
        "Internal exposure is deferred",
        "Explicit exposure approval is absent",
        "No internal exposure is enabled",
        "No public/tenant/customer exposure is enabled",
        "Future exposure requires resume criteria",
    ):
        assert required_text in closeout


def test_historical_read_only_chat_pilot_readiness_stream_resume_stops_and_authorisation():
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT)
    resume = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_FUTURE_RESUME_CRITERIA)
...
def test_historical_read_only_chat_pilot_readiness_stream_decision_record_defaults_are_conservative():
    record = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_DECISION_RECORD)
...
def test_historical_read_only_chat_pilot_final_no_exposure_attestation():
    attestation = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_NO_EXPOSURE_ATTESTATION)
...
def test_historical_read_only_chat_pilot_readiness_stream_closeout_updates_existing_controls():
    deferred_closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_DEFERRED_CLOSEOUT)
    resume = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_INTERNAL_EXPOSURE_RESUME_CRITERIA)
    boundaries = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_REMAINING_RUNTIME_BOUNDARIES)
    index = _read(HISTORICAL_KNOWLEDGE_CONTROL_INDEX)

    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT.md" in deferred_closeout
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_FUTURE_RESUME_CRITERIA.md" in resume
    assert "readiness stream closeout as the current boundary" in boundaries
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT.md" in boundaries
    ...
    for linked_doc in (
        ...
        "HISTORICAL_READ_ONLY_CHAT_PILOT_FUTURE_RESUME_CRITERIA.md",
        "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_NO_EXPOSURE_ATTESTATION.md",
        "2026-05-16_minerva_historical_read_only_chat_pilot_readiness_stream_closeout_v0_1.md",
        "CLOSED_DEFERRED_PENDING_EXPOSURE_APPROVAL",
    ):
        assert linked_doc in index


def test_historical_read_only_chat_pilot_final_index_resume_map_docs_exist():
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_STATUS.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_RESUME_MAP.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_BOUNDARY_REGISTER.exists()
    assert HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX_RESUME_MAP_PROMPT.exists()


def test_historical_read_only_chat_pilot_final_index_status_and_boundaries():
    final_index = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX)
    ...
    for required_text in (
        ...
        assert required_text in final_index
    ...
    for blocked in (
        ...
        assert blocked in final_index


def test_historical_read_only_chat_pilot_final_index_stream_artefact_groups():
    final_index = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX)
    ...
    for stream_area in (
        ...
        "exposure decision gate",
        "internal exposure deferred closeout",
        "readiness stream closeout",
        "final index/resume map",
    ):
        assert stream_area in final_index


def test_historical_read_only_chat_pilot_resume_map_triggers_and_non_authorisation():
    resume_map = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_RESUME_MAP)
    ...
    for required_mapping in (
        ...
        assert required_mapping in resume_map

    assert "No trigger itself authorises exposure, LLM calls, final answers, DB access, corpus mutation, or production use" in resume_map


def test_historical_read_only_chat_pilot_final_boundary_register():
    register = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_BOUNDARY_REGISTER)
    ...
    for boundary in (
        ...
        assert boundary in register


def test_historical_read_only_chat_pilot_final_status_summary():
    status = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_STATUS)

    for required_field in (
        "| ControlledReadinessComplete | Yes |",
        "| ExposureDeferred | Yes |",
        "| ExplicitExposureApprovalPresent | No |",
        "| InternalExposureEnabled | No |",
        "| ProductionChatExposed | No |",
        "| LiveLLMCalled | No |",
        "| FinalAnswerGenerated | No |",
        "| DBReadWritePerformed | No |",
        "| CorpusMutationPerformed | No |",
        "| ResumeRequiresExplicitApproval | Yes |",
        "| NoExposureBoundaryPreserved | Yes |",
    ):
        assert required_field in status


def test_historical_read_only_chat_pilot_final_index_updates_controls_and_closeout():
    index = _read(HISTORICAL_KNOWLEDGE_CONTROL_INDEX)
    closeout = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_CLOSEOUT)
    decision = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_DECISION_RECORD)
    inventory = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_READINESS_STREAM_ARTEFACT_INVENTORY)
    resume_criteria = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_FUTURE_RESUME_CRITERIA)
    attestation = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_NO_EXPOSURE_ATTESTATION)

    for linked_doc in (
        "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX.md",
        "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_STATUS.md",
        "HISTORICAL_READ_ONLY_CHAT_PILOT_RESUME_MAP.md",
        "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_BOUNDARY_REGISTER.md",
        "2026-05-16_minerva_historical_read_only_chat_pilot_final_index_resume_map_v0_1.md",
        "CONTROLLED_READINESS_COMPLETE_EXPOSURE_DEFERRED",
        "complete/deferred",
    ):
        assert linked_doc in index

    assert "Final Index And Resume Map" in closeout
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_INDEX.md" in closeout
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_RESUME_MAP.md" in closeout
    assert "FinalControlledReadinessStatus" in decision
    assert "ControlledReadinessComplete" in decision
    assert "final index/resume map" in inventory
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_RESUME_MAP.md" in resume_criteria
    assert "HISTORICAL_READ_ONLY_CHAT_PILOT_FINAL_BOUNDARY_REGISTER.md" in attestation


def test_historical_read_only_chat_pilot_readiness_stream_slice_introduces_only_allowed_changes():
    changed = subprocess.run(
        ["git", "status", "--short"],
        capture_output=True,
        text=True,
...
def test_historical_read_only_chat_pilot_orchestrator_links_from_existing_controls():
    for path in (
        ...
        content = _read(path)
        assert "HISTORICAL_READ_ONLY_CHAT_PILOT_IMPLEMENTATION_CANDIDATE.md" in content
...
def test_historical_read_only_chat_pilot_orchestrator_slice_introduces_only_allowed_changes():
    changed = subprocess.run(
        ["git", "status", "--short"],
        capture_output=True,
        text=True,
    ...
    service = _read(HISTORICAL_READ_ONLY_CHAT_PILOT_ORCHESTRATOR_CANDIDATE_SERVICE).lower()
    assert "openai" not in service
    assert "chatcompletion" not in service
    assert "responses.create" not in service
    assert "retrieve_relevant_chunks" not in service
